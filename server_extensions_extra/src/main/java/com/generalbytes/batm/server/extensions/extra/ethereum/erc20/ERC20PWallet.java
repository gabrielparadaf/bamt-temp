...
public class ERC20PWallet implements IWallet{
    ...
    private static final Logger log = LoggerFactory.getLogger(ERC20PWallet.class);

    public ERC20PWallet(String projectId, String mnemonicOrPassword, String tokenSymbol, int tokenDecimalPlaces, String contractAddress, BigInteger fixedGasLimit, BigDecimal gasPriceMultiplier) {
